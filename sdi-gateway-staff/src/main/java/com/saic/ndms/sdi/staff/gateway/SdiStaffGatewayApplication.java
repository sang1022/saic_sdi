...
package com.saic.ndms.sdi.staff.gateway;
...
@MapperScan(basePackages = { "com.saic.ndms.sdi.staff.gateway.dao", "com.saic.ndms.sdi.staff.gateway.dao" })
@EnableTransactionManagement
@EnableDiscoveryClient
public class SdiStaffGatewayApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SdiStaffGatewayApplication.class, args);
    }
